                ...
                if status == 'active':
                    if signal_type == 'buy':
                        ...
                        try:
                            ...
                            pass
                # except block removed (stray except)
...
def index():
    ...
    # إذا لم يكن هناك جلسة، عرض صفحة هبوط أو تحويل للدخول
    if not user_info['success']:
        signals = load_signals()
...
"""
        ...
        # تعريف CHAT_ID من متغير البيئة أو تعيين قيمة افتراضية
